			...
			<div class="content ">
				...
				<div class="input clearfix">
					...
					<div class="right">
						...
						<form method="post" action="">
						посмотреть Postgre<input type="submit" name="watchPostgre" value="watchPostgre">
						</form>
						<form method="post" action="">добавить Postgre<p><input type="text" name="string"/><input type="submit" name="addPostgre" value="AddPostgre">
						</form>
						<form method="post" action="">
						удалить Postgre<input type="submit" name="deletePostgre" value="deletePostgre">
						</form>
						</div>
					</div>
